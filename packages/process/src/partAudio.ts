...
import type { PartRecord } from "./partIndex";
import { getPlayerPublicRoot } from "./runtimePaths";
...
function getGeneratedPartAbsolutePath(part: PartRecord) {
  return path.join(getPlayerPublicRoot(), getGeneratedPartRelativePath(part));
}
