...
import { getDefaultPartsRoot, getDefaultRawAudioRoot } from "./runtimePaths";
...
const PARTS_ROOT = process.env.PARTS_ROOT_DIR || getDefaultPartsRoot();
const RAW_AUDIO_ROOT = process.env.RAW_AUDIOS_DIR || getDefaultRawAudioRoot();
